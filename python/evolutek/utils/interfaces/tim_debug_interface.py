...
class TimDebugInterface(Interface):
    ...
    def print_polygon(self, points, color):
        ...
        for i in range(1, len(points)):
            ...
            self.canvas.create_line(
                p1.y * self.interface_ratio,
                p1.x * self.interface_ratio,
                p2.y * self.interface_ratio,
                p2.x * self.interface_ratio,
                width=5,
                fill=color,
            )
    ...
    def init_interface(self):
        ...
        # TIM debug Button
        self.tim_debug_button = Button(
            self.window,
            text="Debug mode: %s" % "On" if self.tim_debug else "Off",
            command=self.change_debug_tim,
            bg="green" if self.tim_debug else "red",
        )
    ...
    def update_interface(self):
        ...
        self.tim_debug_button.config(
            text="Debug mode: %s" % self.tim_debug,
            bg="green" if self.tim_debug else "red",
        )
